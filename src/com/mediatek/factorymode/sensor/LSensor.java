  ...
  implements SensorEventListener
{
  ...
  public void onCreate(Bundle paramBundle)
  {
    ...
    this.mBtOk = (Button)findViewById(R.id.lsensor_bt_ok);
    ...
    this.mBtFailed = (Button)findViewById(R.id.lsensor_bt_failed);
