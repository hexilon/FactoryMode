...
public class Report extends Activity
{
  ...
  protected void ShowInfo()
  {
    ...
    StringBuilder localStringBuilder3 = new StringBuilder().append(str2).append(getString(R.string.report_failed)).append(str2);
    ...
    StringBuilder localStringBuilder5 = new StringBuilder().append(str2).append(getString(R.string.report_notest)).append(str2);
  ...
  protected void onCreate(Bundle paramBundle)
  {
    ...
    for(int i = 0; i < this.itemString.length; i++){
        ...
        if(this.mSp.getString(getString(this.itemString[i]), "").equals("success"))
        {
            this.mOkList.add(getString(this.itemString[i]));
        }
        else if(this.mSp.getString(getString(this.itemString[i]), "").equals("failed"))
        {
