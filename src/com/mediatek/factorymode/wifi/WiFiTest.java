...
//		    this.mNetWorkName = str1;
  ...
  {
    SharedPreferences localSharedPreferences = this.mSp;
    if(paramView.getId() == this.mBtOk.getId()&&isWifi){
        Utils.SetPreferences(this, localSharedPreferences, R.string.wifi_name, "success");
        finish();
  ...
  public void onCreate(Bundle paramBundle)
  {
    ...
    this.mBtOk = (Button)findViewById(R.id.wifi_bt_ok);
    this.mBtFailed = (Button)findViewById(R.id.wifi_bt_failed);
